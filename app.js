...
function App (charm) {
	...
	function create_sounds() {
		...
		app.play_wrong_sound 	= function() {
			wrong.volume(0.5);
			wrong.play();
		};
		app.play_press_sound 	= function() {
			press.volume(0.5);
			press.play();
		};
	...
	function create_pencil() {
		...
		app.get_pencil_pos = function () {
			return [img.transform.x, img.transform.y];
		};
	}
	...
	function create_check_flag () {
		...
		app.show_correct_flag = function () {
			...
			correct_flag.transform.x = pencil_pos[0]-50;
			correct_flag.transform.y = pencil_pos[1]-50;
			propagator.riseSubscriber(correct_flag.image, true);
			correct_flag.transform.alpha = 1;
		...
		app.show_false_flag = function () {
			...
			let pencil_pos = app.get_pencil_pos();
			false_flag.transform.x = pencil_pos[0]-40;
			false_flag.transform.y = pencil_pos[1]-60;
